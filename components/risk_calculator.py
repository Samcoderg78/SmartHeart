...
def render_risk_calculator(user_data, language):
    ...
    # Get model and predict risk - ensure this uses the latest user_data
    model = get_model()
    # Debug information - shows what data is being sent to the model
    ...
    with col2:
        ...
        # Display risk category with color-coded box
        category_styles = {
